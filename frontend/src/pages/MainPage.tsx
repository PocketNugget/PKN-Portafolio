        ...
        <div className="container">
          ...
          <div className="blog-grid">
            <div className="blog-card featured">
              <div className="blog-content">
                ...
                <h3 className="blog-title">
                  Easy for Us, Complex for AI: Assessing the Coherence of
                  Generated Realistic Images
                </h3>
                <p className="blog-excerpt">
                  Published research analyzing and benchmarking metrics to
                  evaluate the realism of images generated by advanced AI
                  models, including GANs, Transformers, and Diffusion Models.
                  This work contributes to the field of generative model
                  evaluation and understanding AI perception.
                </p>
                <div className="blog-meta">
                  ...
                  <span className="blog-category">AI Research</span>
                  <span className="blog-publisher">Springer</span>
                </div>
              </div>
            </div>
            ...
            <div className="blog-card">
              <div className="blog-content">
                <h3 className="blog-title">
                  Understanding Zero-Day Vulnerabilities in Modern Enterprise
                  Environments
                </h3>
                <p className="blog-excerpt">
                  An in-depth analysis of zero-day vulnerabilities, their
                  discovery methods, exploitation techniques, and mitigation
            ...
            <div className="blog-card">
              <div className="blog-content">
                <h3 className="blog-title">
                  Advanced Phishing Techniques and Defenses: A Comprehensive
                  Guide
                </h3>
                <p className="blog-excerpt">
                  Modern phishing campaigns use sophisticated social engineering
                  combined with technical exploits. This guide covers latest
          ...
          <div className="contact-content">
            <div className="contact-info">
              ...
              <p>
                ...
                or just sharing knowledge about cybersecurity and AI. Whether
                you have a project in mind or just want to chat about the latest
                security trends, feel free to reach out!
              </p>
              ...
              <div className="contact-methods">
                <div className="contact-method">
                  ...
                  <div className="method-details">
                    <h4>Email</h4>
                    <span>goben.ca.pkn@hotmail.com</span>
                  </div>
                </div>
                ...
                <div className="contact-method">
                  ...
                  <div className="method-details">
                    <h4>GitHub</h4>
                    <span>github.com/goben-diego</span>
                  </div>
                </div>
